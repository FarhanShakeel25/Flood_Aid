  ...
  return (
    <div className="contact-form-container">
      <div className="form-header">
        <h1>Contact Flood Aid</h1>
        <p className="subtitle">Government Flood Management Portal</p>
        
        <div className="instructions">
          <p><strong>Before submitting, please note:</strong></p>
          <ul>
            <li>For emergency flood assistance, call the national helpline: <strong>1090</strong></li>
            <li>Select the appropriate subject to ensure timely response</li>
            <li>Provide accurate contact information for follow-up</li>
            <li>For flood alerts, include specific location details in your message</li>
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        <div className="form-footer">
          <p className="disclaimer">
            By submitting this form, you agree to our privacy policy. Your information will be used solely for flood management purposes.
          </p>
