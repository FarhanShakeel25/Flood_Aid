...
const AdminLayout = ({ children }) => {
  ...
  const mockNotifications = [
    {
      id: 1,
      title: "New Donation",
      message: "Rs. 5,000 received from Ali Khan",
      time: "5 min ago",
      unread: true,
    },
    {
      ...
      message: "Emergency request from District 9",
      time: "15 min ago",
      unread: true,
    },
    {
      ...
      message: "New volunteer signed up",
      time: "1 hour ago",
      unread: false,
    },
  ];
  ...
  return (
    <div className="admin-container" data-theme={theme}>
      ...
      {/* Sidebar */}
      <aside
        className={`admin-sidebar ${!isSidebarOpen ? "collapsed" : ""} ${isMobileMenuOpen ? "mobile-open" : ""}`}
      >
        {/* Header */}
